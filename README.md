...
This is my version of the Foundry DeFi Stablecoin project, described in the lesson 12 of the foundry-full-course by patrickcollins.
[Foundry Full Course](https://github.com/Cyfrin/foundry-full-course-f23)

One extra I added was that the decimal precision of price feeds is not hardcoded but retrived using the decimals(). This is because the decimals of the price feeds can be different for different tokens, althout in this project they are all 8 decimals.
...
```
git clone https://github.com/andrejscek/foundry-stablecoin
